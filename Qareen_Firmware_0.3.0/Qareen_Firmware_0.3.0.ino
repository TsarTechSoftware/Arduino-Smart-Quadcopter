...
Add yaw.
Test program.
Test for serial altitude manipulation.
Must change the pins to account for arduino mega.
Test program.
Delete the code that was oriented for bluetooth.
Delete serial code for console manipulation.
Create code for the altitude alone.
Test.
Code the rest of the throttles.
Test.
...
0.3.3
Hook battery up to pin so can auto land.

0.3.4
Create automatic landing sequence 

0.4.0
GPS

0.5.0
Cleaning phase. Clean everything.
